...
Func BuildAdvancedCombatSkillSummary($skillConfig)
	...
	Local $gatesLine = 'Gates: ' & $gateSummary
	If StringLen($gatesLine) > 52 Then $gatesLine = StringLeft($gatesLine, 49) & '...'
	Return 'Type: ' & StringLower($skillConfig.Item('type')) & @CRLF & $gatesLine
EndFunc
