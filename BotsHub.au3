...
#include 'src/utilities/StuckDetectionTest.au3'
...
Global Const $AVAILABLE_FARMS = '|Asuran|Boreal|CoF|Corsairs|Deldrimor|Dragon Moss|Eden Iris|Feathers|Follower|FoW|FoW Tower of Courage|Froggy|Gemstones|Gemstone Margonite|Gemstone Stygian|Gemstone Torment|' & _
	...
	'Raptors|SoO|SpiritSlaves|Sunspear Armor|Tasca|Underworld|Vaettirs|Vanguard|Voltaic|War Supply Keiran|Storage|Tests|TestSuite|Dynamic execution|Stuck Detection Test'
...
Func FillFarmMap()
	...
	AddFarmToFarmMap(	'Stuck Detection Test',			StuckDetectionTest,				0,					2 * 60 * 1000)
